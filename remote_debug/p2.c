...
unsigned char  Loop_foo_function_while1(int* a, int  n, int* rvp_i, int* rvp_j, int* rvp_rvretval);
...
int  foo_function(int* a, int  n)
{
    ...
    {
        Loop_foo_function_while1(a, n, &i, &j, &rvretval);
    }
...
unsigned char  Loop_foo_function_while1(int* a, int  n, int* rvp_i, int* rvp_j, int* rvp_rvretval)
{
    ...
    {
        return Loop_foo_function_while1(a, n, rvp_i, rvp_j, rvp_rvretval);
    }
    return 0;
}
